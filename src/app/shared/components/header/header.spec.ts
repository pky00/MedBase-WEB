...
describe('HeaderComponent', () => {
  ...
  it('should return initials from user name', () => {
    mockCurrentUser.set({
      ...
      third_party: { id: 1, code: 'TP-001', name: 'John Doe', phone: null, email: null, is_active: true, is_deleted: false, created_by: null, created_at: '', updated_by: null, updated_at: '' },
