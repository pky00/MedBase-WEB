...
| 12 | Patient Documents | 2026-03-05 | Document upload/list/delete integrated into patient view page. File upload with optional document type via multipart/form-data. Document cards with name, type badge, date, download link, and delete action. Added postFormData method to ApiService for file uploads |
